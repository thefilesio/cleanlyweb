          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  {/* Step number - original position (hidden on mobile) */}
                  <div className="absolute -top-4 -left-4 w-8 h-8 bg-clean-green text-white rounded-full flex items-center justify-center font-bold text-sm leading-none hidden md:flex" style={{ lineHeight: '1' }}>
                    {index + 1}
                  </div>
